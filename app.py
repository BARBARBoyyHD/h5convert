...
def predict():
    ...
    try:
        ...
        # Round the confidence to 0 or 1
        predicted_class_index = int(np.round(max_confidence))
        predicted_class = class_names[predicted_class_index]  # Use the rounded index to get the class name
